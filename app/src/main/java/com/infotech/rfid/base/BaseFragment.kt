...
import com.infotech.rfid.data.api.jstp.toMessage
import org.koin.androidx.viewmodel.compat.SharedViewModelCompat.sharedViewModel
import java.lang.reflect.ParameterizedType


@Suppress("DEPRECATION")
open class BaseFragment<DB : ViewDataBinding, VM : BaseViewModel<*>> : Fragment(), OnNewIntent,
    ...
    open fun onError(data: ErrorData){
        ...
        val text = data.toMessage(requireContext())
        text?.let {
            builder.append(text)
        }?: kotlin.run {
